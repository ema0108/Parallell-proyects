...
def process_tweets(directory, start_date, end_date, hashtags):
    tweets = []
...
def main():
    ...
    validate_args(args)
    tweets = process_tweets(args.directory, args.start_date, args.end_date, hashtags)
